...
class _baseDes(object):
    def __init__(self, mode=ECB, IV=None, key=None, pad=None, padmode=PAD_NORMAL):
        if IV:
            IV = self._checkIfUnicode(IV)
        if pad:
        ...
        # if IV is None:
        #     raise ValueError("Algo necessitates a message")
...
class des(_baseDes):
    ...
    def __init__(self, key, mode=ECB, IV=None, pad=None, padmode=PAD_NORMAL):
        ...
        _baseDes.__init__(self, mode, IV, cheie, pad, padmode)
        self.key_size = 8
    ...
    def des_crypt(self, block, crypt_type):
        ...
        #  print(block)
        # block = self.String_to_BitList2(block)  not needed
        ...
        print("AAAAAA:")
       # print(self.R + self.L)  not sussy
       # print(len(self.R + self.L)) correct
    ...
    def crypt(self, data, crypt_type):
        ...
        if len(data) % self.block_size != 0:
            ...
            if not self.getPadding():
                ...
                # data += chr((self.block_size - (len(data) % self.block_size)) * self.getPadding())
...
if __name__ == "__main__":
    ...
    DES = des(cheie, ECB, None,"X" , PAD_NORMAL)
    result = DES.crypt(mesaj, des.ENCRYPT)
    print("Mesaj: " + mesaj)
    print(result.hex())